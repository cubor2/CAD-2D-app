...
import { useElementTransforms } from './hooks/useElementTransforms';
...
const CADEditor = () => {
  ...
  // Hook pour les transformations d'éléments (Phase 2.3 du refactoring)
  const {
    handleRotate,
    handleFlipHorizontal,
    handleFlipVertical,
    handleResizeElement
  } = useElementTransforms(selectedIds, elements, updateElements, GRID_SIZE);
  ...
  // Les fonctions de transformation (rotate, flip, resize) sont maintenant dans useElementTransforms hook ✅
  ...
  // Réinitialiser le hover cursor et editingTextId quand on change de tool pour forcer le re-render avec les bonnes couleurs
  useEffect(() => {
